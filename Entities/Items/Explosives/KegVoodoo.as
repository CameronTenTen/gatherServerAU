...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	if (vellen > 1.7f)
	{
		...
		{
			//make kegs half as effective when dropped
			f32 multiplier = 0.5f;
			this.set_f32("explosive_radius", this.get_f32("explosive_radius")*multiplier);
			this.set_f32("explosive_damage", this.get_f32("explosive_radius")*multiplier);
			this.set_f32("map_damage_radius", this.get_f32("explosive_radius")*multiplier);
			Boom(this);
		}
	}
}
