 ...
 */
 ...
 //modified to remove scramble teams on new map, team auto balance and put players in gather team on join

#include "PlayerInfo.as";
#include "BaseTeamInfo.as";
//#include "RulesCore.as";			//this is included in gatherManageTeams.as
...
void onPlayerRequestTeamChange(CRules@ this, CPlayer@ player, u8 newTeam)
{
	...
	gatherMatch@ gatherGame = getGatherObject(this);
	if(!gatherGame.isGameRunning) {			//if no game is running, players can do what they want
